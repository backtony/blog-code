...
public class MemberRestController {
    ...
    @GetMapping("/redis/{memberId}")
    public ResponseEntity<MemberInfoResponse> getRedis(@PathVariable Long memberId) {
        return ResponseEntity.ok(MemberInfoResponse.from(memberService.getRedisMember(memberId)));
    }
